...
const Login = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      navigate(from, { replace: true }); // Navigate to the intended location
    } catch (err) {
    ...
    <div className="my-2 min-h-screen flex items-center justify-center bg-gradient-to-r from-blue-500 via-purple-500 to-pink-500">
      <div className="bg-white shadow-lg rounded-lg p-8 max-w-sm w-full">
        ...
        <button
          ...
          className="flex items-center justify-center w-full py-3 bg-blue-600 text-white rounded-md shadow-md hover:bg-blue-700 transition"
        >
